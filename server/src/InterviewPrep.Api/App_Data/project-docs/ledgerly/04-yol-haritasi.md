...
**Durum (2026-09-15):** Devam ediyor. Create Wallet, Get Wallet (ID ile okuma), PostgreSQL ve HTTP testleri tamamlandı. POST Location üzerinden yeni wallet okunabiliyor. Küçük bir concurrency ön lab'ında aynı wallet'ın eşzamanlı oluşturulması 201/409 ile doğrulandı; bu, Aşama 2'deki double-spending veya idempotency çalışmalarının tamamlandığı anlamına gelmez. Double-entry ledger için dengeli JournalEntry/Posting domain modeli ve 29 yeni domain testi tamamlandı; [19. bölüm](19-double-entry-ledger-domain.md). LedgerAccount, ledger persistence, test bakiyesi yatırma ve transfer sıradadır. Toplam 62 test geçti.
